...
const BotName = 'RibasBot'; 
const instagram = '@rbs.420'; 
const aktif = 'Tergantung Jaringan';
...
fs.existsSync('./session.json') && conn.loadAuthInfo('./session.json') //create ribas bot
